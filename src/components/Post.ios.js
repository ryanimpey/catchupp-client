...
import { Text, View, TouchableOpacity, StyleSheet, Image, Dimensions, ActionSheetIOS, Alert } from "react-native";
...
import { HeartWithDotRedIcon, HeartWithDotOutlineIcon, HeartWithDotIcon } from "../svgs";
...
const Post = ({ item, index, navigation, account, handlePostChange }) => {
    ...
    // Allows the reporting of a post via an IOSActionSheet, which takes in a callback that provides the clicked index
                ...
                <View style={{ flexDirection: "row", flex: 1, alignItems: "center" }}>
                    ...
                    >
                        <View style={{ flex: 1, flexDirection: "row", alignItems: "center" }}>
                            ...
                            <Text style={{ fontWeight: "700" }}>{user?.displayName ?? 'Unknown User'}</Text>
                        </View>
